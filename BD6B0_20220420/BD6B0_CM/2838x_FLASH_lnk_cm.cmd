...
// CMTOCPU2MSGRAM1  : origin = 0x20086800, length = 0x00000800
   CPU1TOCMMSGRAM0  : origin = 0x20080000, length = 0x00001000
   CMTOCPU1MSGRAM0  : origin = 0x20082000, length = 0x00001000
   CPU2TOCMMSGRAM0  : origin = 0x20084000, length = 0x00001000
   CMTOCPU2MSGRAM0  : origin = 0x20086000, length = 0x00001000
}
...
//  MSGRAM1_CM_TO_CPU1 : > CMTOCPU1MSGRAM1, type=NOINIT
//  MSGRAM1_CM_TO_CPU2 : > CMTOCPU2MSGRAM1, type=NOINIT
//  MSGRAM1_CPU1_TO_CM : > CPU1TOCMMSGRAM1, type=NOINIT
//  MSGRAM1_CPU2_TO_CM : > CPU2TOCMMSGRAM1, type=NOINIT
